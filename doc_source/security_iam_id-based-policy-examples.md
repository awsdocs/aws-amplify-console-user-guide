# Identity\-based policy examples for Amplify<a name="security_iam_id-based-policy-examples"></a>
...
## Using the Amplify console<a name="security_iam_id-based-policy-examples-console"></a>
